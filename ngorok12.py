...
async def process_photo(update, context):
    ...
    try:
        ...
        if IMGBB_API_KEY != "ef9e1a9e1adfe2d6c8b0b576af3485e6":
        ...
        # Metode 2: Gunakan base64 langsung jika ImgBB gagal atau tidak ada API key
        logger.info("Menggunakan encoding base64")
