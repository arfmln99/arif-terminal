...
PROMPT_ENHANCEMENTS = {
    ...
    "en": {
        ...
        "body_detail": [
            "perfect body anatomy", "ideal body proportions", "fine muscle detail", "proportional body shape",
            "prominent collarbones", "defined abdominal muscles", "muscular arms", "long legs",
            "slim waist", "broad shoulders", "small waist", "curved hips",
            "perfect posture", "ideal bone structure", "long fingers", "slender neck",
            "visible shoulder blades", "defined back muscles", "sharp waistline"
        ],
        "nsfw": [
            "seductive pose", "revealing outfit", "sensual expression", "beautiful body",
            "sensual body curves", "smooth glossy skin", "intimate lighting", "sensual angle",
            "alluring silhouette", "luxury lingerie", "sexy costume", "tight dress",
            "see-through clothing", "glistening skin", "seductive gaze",
            "cleavage", "open back", "long legs", "smooth thighs",
            "glossy lips", "sensual style", "wet clothing", "finger touching lips"
        ],
        "adult": [
